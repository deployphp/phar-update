...
class CommandTest extends TestCase
{
    ...
    public function testExecuteNoUpdates()
    {
        ...
        $this->assertEquals(1, $this->tester->execute(array('command' => self::NAME)));

        $this->assertEquals("No updates could be found.\n", $this->tester->getDisplay());
    }
    ...
    public function testExecuteAlreadyCurrent()
    {
        ...
        file_put_contents("$dir/downloads", utf8_encode(json_encode(array(array('name' => 'test-1.0.0.phar')))));

        $this->tester->execute(array('command' => self::NAME));
    ...
    public function testExecuteRedo()
    {
        ...
        file_put_contents("$dir/downloads", utf8_encode(json_encode(array( array(
        ...
        $this->assertEquals("Update successful!\n", $this->tester->getDisplay());
    }
